...
define('OGP_LANG_system_up_since', "Simula Noong");
define('OGP_LANG_day_word', "Araw");
define('OGP_LANG_days_word', "Days");
define('OGP_LANG_hour_word', "Oras");
define('OGP_LANG_hours_word', "Oras");
define('OGP_LANG_minute_word', "Minute");
define('OGP_LANG_minutes_word', "Minutes");
define('OGP_LANG_second_word', "Second");
define('OGP_LANG_seconds_word', "Secons");
...
define('OGP_LANG_storage_used', "Nagamit na");
define('OGP_LANG_storage_free', "Free Space");
define('OGP_LANG_process_monitor', "Process Monitor");
define('OGP_LANG_status_extension_required', "Kinakailangan ang Extension");
define('OGP_LANG_gd_info', "Kinakailangan ang PHP Extension <a href=\"http://php.net/manual/en/image.installation.php\">GD</a> upang makabuo ng mga bar na larawang ito!") ;
?>